...
image.tar: Dockerfile docker_entrypoint.sh assets/utils/user-signups-off.sh priv-config-forward-all priv-config-forward-onion base-image.tar configurator.py $(shell find ./www)
