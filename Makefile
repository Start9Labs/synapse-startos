...
image.tar: Dockerfile docker_entrypoint.sh check-federation.sh priv-config-forward-all priv-config-forward-onion configurator.py $(shell find ./www)
...
image-x86.tar: synapse/docker/Dockerfile $(SYNAPSE_SRC)
